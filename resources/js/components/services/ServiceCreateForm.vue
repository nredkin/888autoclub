<template>
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        <div class="px-6 py-6 lg:px-8">
            <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Добавление услуги</h3>
            <Alert :errors="errors"/>
...
export default {
    ...
    components: {Checkbox, Alert, TextInput, Success},
    data: function () {
        return {
            loading: false,
            service: {
    ...
    methods: {
        store: async function (event) {
            ...
            this.errors = null
            ServiceService.store(this.service)
                .then(response => {
