            ...
            <div class="mt-7 overflow-x-auto">
                <table class="w-full whitespace-nowrap">
                    ...
                    <tr tabindex="0" class="focus:outline-none h-16 border border-gray-100 rounded">
                        ...
                        <td class="">
                            <div class="flex items-center pl-5">
                                <p class="text-base font-medium leading-none text-gray-700 mr-2">Ключ для интеграции</p>
                            </div>
                        </td>
                        <td class="pl-4">
                    ...
                    <tr v-for="branch of branches" :key=branch.id tabindex="0"
                        ...
                        <td class="">
                            <div class="flex items-center pl-5">
                                <p class="text-base font-medium leading-none text-gray-700 mr-2">{{ branch.wa_token }}</p>
                            </div>
                        </td>
                        <td class="pl-4">
                            <div class="flex">
                                <router-link :to="{path: '/branches/' + branch.id, query: { auth_userId: this.auth_user.roleId}}">
                                ...
                                <button @click="deleteBranch(branch.id)" class="text-red-700 focus:ring-2 focus:ring-offset-2 focus:ring-red-300 text-sm leading-none py-2 px-2 rounded hover:bg-red-200 focus:outline-none">
                                    <svg fill="none" height="25" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
