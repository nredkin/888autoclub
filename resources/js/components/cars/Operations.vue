<template>
  <div class="grid md:grid-cols-3 md:gap-6">
      <div>
          <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Финансовые операции по активу (только расход)</h3>
  ...
  name: 'Operations',
    ...
    methods: {
        ...
        loadOperations: function () {
            OperationService.getOperationsByModelId('car', this.carId).then( response => this.operations = response.data.operations)
        },
